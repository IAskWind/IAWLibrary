 ...
 *  压缩相关工具类
 *  https://github.com/Blankj/AndroidUtilCode/blob/master/utilcode/src/main/java/com/blankj/utilcode/utils/ZipUtils.java
 *  引用来来自https://github.com/Blankj/AndroidUtilCode
 *  一个类里统一前缀，方便快捷代码提示
 */
public class IAW_ZipUtils extends IAW {
    ...
    public static boolean zipFiles(Collection<File> resFiles, String zipFilePath, String comment)
            throws IOException {
        return ZipUtils.zipFiles(resFiles,zipFilePath,comment);
    }
    ...
    public static boolean zipFiles(Collection<File> resFiles, File zipFile)
            throws IOException {
        return ZipUtils.zipFiles(resFiles,zipFile);
    }
    ...
    public static boolean zipFiles(Collection<File> resFiles, File zipFile, String comment)
            throws IOException {
        return ZipUtils.zipFiles(resFiles,zipFile,comment);
    }
    ...
    public static boolean zipFile(String resFilePath, String zipFilePath)
            throws IOException {
        return ZipUtils.zipFile(resFilePath,zipFilePath);
    }
    ...
    public static boolean zipFile(String resFilePath, String zipFilePath, String comment)
            throws IOException {
        return ZipUtils.zipFile(resFilePath,zipFilePath,comment);
    }
    ...
    public static boolean zipFile(File resFile, File zipFile)
            throws IOException {
        return ZipUtils.zipFile(resFile,zipFile);
    }
    ...
    public static boolean zipFile(File resFile, File zipFile, String comment)
            throws IOException {
        return ZipUtils.zipFile(resFile,zipFile,comment);
    }
    ...
    public static boolean unzipFiles(Collection<File> zipFiles, String destDirPath)
            throws IOException {
        return ZipUtils.unzipFiles(zipFiles,destDirPath);
    }
    ...
    public static boolean unzipFiles(Collection<File> zipFiles, File destDir)
            throws IOException {
        return ZipUtils.unzipFiles(zipFiles,destDir);
    }
    ...
    public static Enumeration<?> getEntries(String zipFilePath)
            throws IOException {
        return ZipUtils.getEntries(zipFilePath);
    }
    ...
    public static Enumeration<?> getEntries(File zipFile)
            throws IOException {
        return ZipUtils.getEntries(zipFile);
    }
}
