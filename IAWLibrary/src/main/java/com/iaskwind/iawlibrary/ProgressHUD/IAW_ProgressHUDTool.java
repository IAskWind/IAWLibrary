...
public class IAW_ProgressHUDTool {
    ...
    public IAW_ProgressHUDTool(Context context){
    ...
    protected void initViews() {
        ...
        rootView = (ViewGroup) layoutInflater.inflate(com.bigkoo.svprogresshud.R.layout.layout_svprogresshud, null, false);
    ...
    //***********************************************IAW Start
    public void iawShow(String msg) {
        if(isShowing())return;
        setMaskType(SVProgressHUDMaskType.Black);
        mSharedView.showWithStatus(msg);
        svShow();

    }
    public void iawShowBaseStatus(int res,String msg) {
        if(isShowing())return;
        setMaskType(SVProgressHUDMaskType.Black);
        mSharedView.showBaseStatus(res,msg);
        svShow();
        scheduleDismiss();
    }
    public void iawShowErrorInfo(String msg) {
        iawShowBaseStatus(R.drawable.error_info,msg);
    }
    public void iawShowSuccessInfo(String msg) {
        iawShowBaseStatus(R.drawable.success_info,msg);
    }
    public void iawShowInfo(String msg) {
        iawShowBaseStatus(R.drawable.default_info,msg);
    }
    public void iawDismiss(){
        dismiss();
    }
    //***********************************************IAW End
    ...
    private void setMaskType(SVProgressHUDMaskType maskType) {
        ...
        switch (mSVProgressHUDMaskType) {
            ...
            case ClearCancel:
                ...
                break;
            case Black:
                configMaskType(com.bigkoo.svprogresshud.R.color.bgColor_overlay, true, false);
                break;
            case BlackCancel:
                configMaskType(com.bigkoo.svprogresshud.R.color.bgColor_overlay, true, true);
                break;
            case Gradient:
                configMaskType(com.bigkoo.svprogresshud.R.drawable.bg_overlay_gradient, true, false);
                break;
            case GradientCancel:
                configMaskType(com.bigkoo.svprogresshud.R.drawable.bg_overlay_gradient, true, true);
                break;
            default:
                break;
        }
    ...
    private void setCancelable(boolean isCancelable) {
        View view = rootView.findViewById(com.bigkoo.svprogresshud.R.id.sv_outmost_container);
